...
public class ArUcoMarker : MonoBehaviour
{
    ...
    public float getCurrQrDistance() { return getLatestDistance(); }
    public Vector3 getCurrQrDirection() { return getLatestDirection(); }
    public Vector3 getCurrQrPosition() { return getLatestPosition(); }
    public Quaternion getCurrQrRotation() { return getLatestRotation(); }
