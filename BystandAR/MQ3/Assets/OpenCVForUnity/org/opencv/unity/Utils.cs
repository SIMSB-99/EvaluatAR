...
namespace OpenCVForUnity.UnityUtils
{
    public static class Utils
    {
        ...
        * <p>
        * <br>This method converts the OpenCV Mat to the Unity Texture2D image. Conversion is possible even when the number of bytes per pixel is different: 8UC1 -> RGBA32 
        * <br>The Mat object must have the types 'CV_8UC4' (RGBA) , 'CV_8UC3' (RGB) or 'CV_8UC1' (GRAY). For other than these types, use #fastMatToTexture2D .
        ...
        *
        * @param mat the Mat object must have the types 'CV_8UC4' (RGBA) , 'CV_8UC3' (RGB) or 'CV_8UC1' (GRAY).  For other than these types, use #fastMatToTexture2D .
        ...
        * <p>
        * <br>This method converts the Unity Texture2D image to the OpenCV Mat. Conversion is possible even when the number of bytes per pixel is different: RGBA32 -> 8UC1
        ...
        * <p>
        * <br>This method converts the Unity WebCamTexture image to the OpenCV Mat. Conversion is possible even when the number of bytes per pixel is different: RGBA32 -> 8UC1
