...
namespace OpenCVForUnityExample.DnnModel
{
    ...
    public class MediaPipeHandPoseEstimator
    {
        ...
        public virtual void visualize(Mat image, Mat result, bool print_result = false, bool isRGB = false, string label = null)
        {
            if (image.IsDisposed)
                return;
            ...
            {
                Imgproc.putText(image, label, new Point(left, top + 36), Imgproc.FONT_HERSHEY_DUPLEX, 0.5, point_color, 1);
            }
