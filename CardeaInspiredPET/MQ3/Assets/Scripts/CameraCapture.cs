...
public class CameraCapture : MonoBehaviour
{
    ...
    //private WebCamTexture cameraFrameWebTexture;
    ...
    void Update()
    {
        ...
        // TODO: check if debug quad position is auto updating since it is a child of camera
        ...
        {
            cameraFrame.SetPixels(webCamTextureManager.WebCamTexture.GetPixels());
            cameraFrame.Apply();    // TODO: check if i need to apply or not

            // ADD HOOK FOR TO GET CAMERA FRAMES
            anotherPETScript.setCurrFrame(cameraFrame, cameraFrame.width, cameraFrame.height);
        }
    ...
    public PassthroughCameraEye getCameraEye()
    {
        return CameraEye; 
    }
